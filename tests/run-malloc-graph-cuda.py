...
TESTS = (
    ...
    "malloc-graph-missing-subgraph-cuda.py",
    "malloc-graph-extra-subgraph-cuda.py",
    "malloc-graph-deep-nesting-cuda.py",
    "malloc-graph-recursive-subgraph-cuda.py",
    ...
    "malloc-graph-short-subgraph-replay-cuda.py",
    "malloc-graph-long-subgraph-replay-cuda.py",
    ...
    "malloc-graph-allocation-before-replay-cuda.py",
